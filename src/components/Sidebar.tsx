import { Layout, Building2, AlertCircle, Bookmark } from 'lucide-react';
...
export const Sidebar = ({
    ...
    return (
        <aside className="w-72 bg-white border-r border-slate-200 h-[calc(100vh-64px)] fixed left-0 top-16 overflow-y-auto hidden lg:block">
                ...
                <div>
                    ...
                    <div className="space-y-1">
                        <button
                            ...
                            className={`w-full flex items-center justify-between p-3 transition-all ${!selectedDeptId ? 'bg-orange-50 text-orange-600' : 'text-slate-600 hover:bg-slate-50'}`}
                        >
                    ...
                    <div className="space-y-1">
                        {departments.map((dept) => (
                            <button
                                ...
                                className={`w-full flex items-center justify-between p-3 transition-all ${selectedDeptId === dept.id ? 'bg-orange-50 text-orange-600 border-r-2 border-orange-600' : 'text-slate-600 hover:bg-slate-50'}`}
                            >
