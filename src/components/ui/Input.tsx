...
export const Input = ({ label, error, as = 'input', className = '', ...props }: InputProps) => {
    const Component = as;
    const baseStyles = "w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800/40 border text-sm dark:text-white transition-all outline-none rounded-2xl font-bold placeholder:text-slate-400 dark:placeholder:text-slate-600";
