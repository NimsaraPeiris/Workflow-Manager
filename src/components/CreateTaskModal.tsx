...
export const CreateTaskModal = ({
    ...
    const isDirty = !!(newTask.title || newTask.description || newTask.team_id || newTask.assignee_id || newTask.due_date);
    ...
    return (
        <>
                                ...
                                <div className="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar overscroll-contain">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <select
                                            ...
                                            className={`w-full px-5 py-3.5 border border-slate-200 dark:border-slate-700 rounded-none focus:border-orange-500 dark:focus:ring-8 dark:focus:ring-orange-500/10 dark:text-white outline-none transition-all appearance-none font-bold ${newTask.team_id ? 'bg-slate-100 dark:bg-slate-800/20 cursor-not-allowed text-slate-400 dark:text-slate-600' : 'bg-slate-50 dark:bg-slate-800/40 cursor-pointer'}`}
                                        >
                                        ...
                                        {newTask.team_id && (
                                            <p className="text-[10px] text-orange-600 dark:text-orange-400 font-bold ml-1 mt-1 animate-in fade-in duration-300">
                                                Auto-set from selected squad's department
                                            </p>
                                        )}
                                    </div>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setNewTask({
                                                        ...
                                                        assignee_id: '',
                                                        // Auto-set department to the team's department
                                                        ...(selectedTeam?.department_id ? { department_id: selectedTeam.department_id } : {})
                                                    });
                                                }}
            ...
            <ConfirmationModal
                ...
                description="You have unsaved changes. Are you sure you want to close? All entered data will be lost."
                confirmText="Discard"
